...
//            removeFirstDataInChart();
            ...
            setChartYAxisProperties(lineChartX);
            setChartYAxisProperties(lineChartY);
            setChartYAxisProperties(lineChartZ);
    ...
    private void initChartLand() {
        ...
        setChartYAxisProperties(lineChartLand);
    }
    ...
    private void setChartYAxisProperties(LineChart lineChart) {
        //自動縮放Y軸
